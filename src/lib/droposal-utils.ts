...
export function formatDroposalForTable(params: DroposalParams): Array<{
  ...
  return [
    ...
    { parameter: 'Max Purchase Per Address', value: params.saleConfig.maxSalePurchasePerAddress.toString() },
    { parameter: 'Public Sale Start', value: new Date(Number(params.saleConfig.publicSaleStart) * 1000).toLocaleString() },
    { parameter: 'Public Sale End', value: new Date(Number(params.saleConfig.publicSaleEnd) * 1000).toLocaleString() },

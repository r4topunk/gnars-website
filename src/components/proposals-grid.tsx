...
import { ProposalCard, Proposal, ProposalStatus } from "@/components/recent-proposals"
        ...
        const mapped: Proposal[] = (sdkProposals as SdkProposal[] | undefined ?? []).map((p) => ({
          ...
          status: (() => {
            ...
            switch (up) {
              ...
              case 'CANCELED': return ProposalStatus.CANCELLED
              case 'VETOED': return ProposalStatus.VETOED

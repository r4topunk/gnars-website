...
/* eslint-disable react-hooks/purity, react-hooks/immutability, react-hooks/refs --
   Copied react-three-fiber 3D asset (repurposed from the /lootbox route). It uses
   valid r3f patterns the strict react-hooks rules can't model: Math.random seeds

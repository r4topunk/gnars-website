    ...
    <section className="space-y-8 border-t py-12">
      ...
      <article className="rounded-lg border bg-card p-6 text-card-foreground">
        ...
        <p className="text-sm leading-7 text-muted-foreground md:text-base">
          ...
          "concrete", skateable infrastructure. Through cash for tricks, events, exposition,
          Gnars contests, viral Instagram clips, and global replication, the project keeps the DIY
          spirit alive while spreading Noggles culture in a way no traditional brand or institution
          could. This is an onchain-born project by Gnars DAO and it’s still alive bro, still
          rolling, and still being built.
        </p>
      </article>

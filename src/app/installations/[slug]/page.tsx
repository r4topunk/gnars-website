...
import { InstallationDetail, InstallationDetailSkeleton } from "@/components/installations/InstallationDetail";
...
export async function generateMetadata({ params }: InstallationPageProps): Promise<Metadata> {
  ...
  const description = installation.description || `${installation.obstacleDesign} in ${installation.location.city}, ${installation.location.country}`;

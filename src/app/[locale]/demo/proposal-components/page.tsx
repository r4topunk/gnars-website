    ...
    <div className="space-y-6">
      <div className="bg-muted/50 p-4 rounded-lg border">
        <p className="text-sm text-muted-foreground mb-4">
          Vote choice:{" "}
          <span className="font-semibold text-foreground">{selectedVote || "None selected"}</span>
        </p>
      </div>
...
function TimelockAlertDemo() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 p-6 border rounded-lg bg-muted/50">
        ...
        <div className="inline-flex items-center px-6 py-2 rounded-md bg-secondary text-secondary-foreground font-mono text-lg font-bold">
          {timeLeft}
        </div>
      </div>

      <div className="text-xs text-muted-foreground space-y-2">
        <p>✓ Custom div-based layout with explicit styling</p>
        <p>✓ Blue icon container (w-10 h-10 rounded-full) for visual emphasis</p>
        <p>✓ Larger badge (text-lg px-6 py-2) for countdown prominence</p>
        <p>✓ Responsive flex layout (flex-col mobile, flex-row desktop)</p>
        <p>✓ Maintains visual hierarchy and design consistency</p>
      </div>
    </div>
  );
}
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Proposed by{" "}
              <code className="bg-muted px-2 py-1 rounded text-xs font-mono">0x1234...5678</code> ·
              2 days ago
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-background opacity-50">
            <div className="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M2 6a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zm6 7a1 1 0 100-2 1 1 0 000 2z"
                  clipRule="evenodd"
                />
              </svg>
            </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-background opacity-50">
            <div className="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M5 2a1 1 0 011 1v1h1V3a1 1 0 011-1h5a1 1 0 011 1v1h1V3a1 1 0 011 1v1h2a2 2 0 012 2v13a2 2 0 01-2 2H4a2 2 0 01-2-2V7a2 2 0 012-2h2V3a1 1 0 011-1z"
                  clipRule="evenodd"
                />
              </svg>
            </div>

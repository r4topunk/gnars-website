---
name: eth-wallets
description: Ethereum wallet patterns, key safety, and transaction guardrails. Use when working with wallet connections, transaction signing, bidding, voting, or any Web3 interaction in this dApp. Covers EOAs, Safe multisig, EIP-7702, account abstraction, and critical security rules for AI agents handling wallet operations.
---
...
6. **Double-check addresses.** Use checksum validation. A single wrong character = permanent loss.
...
- Encrypted keystore (password-protected) — OK
...
async function sendSafely(wallet, to, value) {
  ...
  const totalCostUSD = Number(ethers.formatEther(value + gasCost)) * 2000;
...
- **ERC-4337 spec:** https://eips.ethereum.org/EIPS/erc-4337
